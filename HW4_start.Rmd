...
table(tele2_predictions, test$y)

# look at agreement vs non-agreement
agreement <- tele2_predictions == test$y
table(agreement)
...
tele_trainComb2 <- teleCombined[1:12356, ]
tele_testComb2  <- teleCombined[12356:41188, ]
...
prop.table(table(tele_trainComb2$y))
prop.table(table(tele_testComb2$y))
